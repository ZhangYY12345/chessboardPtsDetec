...
{
	//ours
	cv::Mat img4 = imread("D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/20191231/patternsImgL/12_pattern4.jpg");
	cv::Mat img5 = img4.clone();
	cvtColor(img4, img4, COLOR_BGR2GRAY);
	//{
	//	vector<cv::Mat> oneImgs;
	//	cv::Mat img0 = imread("D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/20191231/patternsImgL/12_pattern0.jpg");
	//	cvtColor(img0, img0, COLOR_BGR2GRAY);
	//	cv::Mat img1 = imread("D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/20191231/patternsImgL/12_pattern1.jpg");
	//	cvtColor(img1, img1, COLOR_BGR2GRAY);
	//	cv::Mat img2 = imread("D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/20191231/patternsImgL/12_pattern2.jpg");
	//	cvtColor(img2, img2, COLOR_BGR2GRAY);
	//	cv::Mat img3 = imread("D:/studying/stereo vision/research code/fisheye-stereo-calibrate/fisheyeStereoCalib/fisheyeStereoCalib/fisheyeStereoCalib/20191231/patternsImgL/12_pattern3.jpg");
